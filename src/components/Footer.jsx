      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            ...
            <li><Link to="#" className="text-gray-300 hover:text-white transition">Blog</Link></li>
            <li><Link to="#" className="text-gray-300 hover:text-white transition">FAQ's</Link></li>
            <li><Link to="#" className="text-gray-300 hover:text-white transition">Contact Us</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            ...
            <li><Link to="#" className="text-gray-300 hover:text-white transition">Terms and Conditions</Link></li>
            <li><Link to="#" className="text-gray-300 hover:text-white transition">Return and Refund Policy</Link></li>
            <li><Link to="#" className="text-gray-300 hover:text-white transition">Shipping Policy</Link></li>
            <li><Link to="#" className="text-gray-300 hover:text-white transition">Disclaimer</Link></li>
          </ul>
        </div>
